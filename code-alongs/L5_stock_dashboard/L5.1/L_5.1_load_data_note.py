...
class StockDataAPI:
    """Class with methods to get and process stock data from Alpha Vantage 获取和处理股票数据的方法的类"""
    ...
    def get_stock(self, symbol: str) -> pd.DataFrame:
        """Performs a GET request on Alpha Vantage to get stock data 执行 GET 请求以获取股票数据
